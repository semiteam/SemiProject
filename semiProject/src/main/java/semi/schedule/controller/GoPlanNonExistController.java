...
/**
 * Servlet implementation class GoPlanNonExistController
 */
@WebServlet("/GoPlanNonExist.sd")
public class GoPlanNonExistController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GoPlanNonExistController() {
        super();
