...
import="semi.member.model.vo.Commentery"%> <%@page
import="semi.post.model.vo.Post"%> <%@page
import="semi.common.model.vo.PageInfo"%> <%@page
import="semi.member.model.vo.Member"%> <%@page import="java.util.ArrayList"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
pageEncoding="UTF-8"%> <% PageInfo pi = (PageInfo)request.getAttribute("pi");
PageInfo postPi = (PageInfo)request.getAttribute("postPi"); ArrayList<Member>
  list = (ArrayList<Member
    >)request.getAttribute("list"); ArrayList<Post>
      postList = (ArrayList<Post
        >)request.getAttribute("postList"); ArrayList<Commentery
          >cList = (ArrayList<Commentery
            >)request.getAttribute("cList"); ArrayList<Question
              >qList = (ArrayList<Question
                >)request.getAttribute("qList"); int currentPage =
                pi.getCurrentPage(); int startPage = pi.getStartPage(); int
                endPage = pi.getEndPage(); int maxPage = pi.getMaxPage(); int
                postCurrentPage = postPi.getCurrentPage(); int postStartPage =
                postPi.getStartPage(); int postEndPage = postPi.getEndPage();
                    ...
                    <div class="wrap">
                      ...
                      <div class="under">
                        <div class="side_menu">
                          ...
                          <div
                            id="side_menu_open_2"
                            onclick="location.href='<%=contextPath%>/adminData.ad'"
                          >
                            사용자 통계
                          </div>
                          ...
                          <div
                            ...
                            onclick="location.href='<%= contextPath %>/GoAdmin2.ad'"
                          >
                            <img
                          ...
                          <div
                            ...
                            onclick="location.href='<%= contextPath %>/GoAdmin3.ad'"
                          >
                            <img
                        ...
                        <div class="content">
                              ...
                              <div class="left-inner">
                                ...
                                >
                                  <tr>
                                    ...
                                    <td>
                                      <button
                                        class="btn btn-wide unblock-btn"
                                        data-mno="<%=m.getmNo()%>"
                                      >
                                        차단해제
                                      </button>
                          ...
                          <div class="paging-area" align="center">
                            <% if (currentPage != 1) { %>
                            <button
                              onclick="location.href='<%= contextPath %>/adminList.ad?cpage=<%= currentPage - 1 %>&pCpage=<%=postCurrentPage%>'"
                            >
                              &lt;
                            </button>
                            <% } %> <% for (int p = startPage; p <= endPage;
                            p++) { %> <% if (p == currentPage) { %>
                            <button disabled><%= p %></button>
                            <% } else { %>
                            <button
                              onclick="location.href='<%= contextPath %>/adminList.ad?cpage=<%= p %>&pCpage=<%=postCurrentPage%>'"
                            >
                              <%= p %>
                            </button>
                        ...
                        <div class="main right-main">
                          <div class="inner">
                            ...
                            <div class="paging-area" align="center">
                              ...
                              <button
                                onclick="location.href='<%= contextPath %>/adminList.ad?cpage=<%= currentPage%>&pCpage=<%= postCurrentPage - 1 %>'"
                              >
                                &lt;
                              </button>
                              <% } %> <% for (int p = postStartPage; p <=
                              postEndPage; p++) { %> <% if (p ==
                              postCurrentPage) { %>
                              <button disabled><%= p %></button>
                              <% } else { %>
                              <button
                                onclick="location.href='<%= contextPath %>/adminList.ad?cpage=<%= currentPage%>&pCpage=<%=p%>'"
                              >
                                <%= p %>
                              </button>
                              <% } %> <% } %> <% if (postCurrentPage !=
