...
<body>
	...
	<div class="wrap">
		...
		<div class="under">
			...
			<div class="content">
				<div class="content_1">집 나가면 고생? 국내 여행은 달라!</div>
				<div class="content_2">경주 편</div>
				<div class="content_3">✨ MD 픽 추천 숙소 7선 ✨</div>
				<div class="content_4">
					<!-- Swiper -->
					<div class="swiper mySwiper">
						<div class="swiper-wrapper">
							<div class="swiper-slide" type="button">
								<img
									src="https://yaimg.yanolja.com/v5/2024/03/22/10/1280/65fd638cca4c54.62821558.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									경주 H Avenue 경주불국사점 <br>
									<br> 130,000원 ~
								</div>
							</div>
							<div class="swiper-slide" type="button">
								<img alt=""
									src="https://yaimg.yanolja.com/v5/2024/03/19/13/1280/65f98e45d7d554.14810113.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									경주 포베르타 스테이 <br>
									<br> 87,000원 ~
							...
							<div class="swiper-slide" type="button">
								<img alt=""
									src="https://yaimg.yanolja.com/v5/2023/06/21/14/1280/64930527a553c8.73852353.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									더 테라스 호텔 경주 <br>
									<br> 135,000원 ~
							...
							<div class="swiper-slide" type="button">
								<img alt=""
									src="https://yaimg.yanolja.com/v5/2023/06/12/11/1280/648707f905b962.10479190.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									이제 경주 <br>
									<br> 250,000원 ~
							...
							<div class="swiper-slide" type="button">
								<img alt=""
									src="https://yaimg.yanolja.com/v5/2023/04/14/14/1280/643964e90e49e7.08374184.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									경주 트라제 풀 빌라 호텔 <br>
									<br> 299,000원 ~
							...
							<div class="swiper-slide" type="button">
								<img alt=""
									src="https://yaimg.yanolja.com/v5/2023/12/16/17/1280/657de29c553373.19840735.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									경주 경주엔 한옥 펜션 <br>
									<br> 180,000원 ~
							...
							<div class="swiper-slide" type="button">
								<img alt=""
									src="https://yaimg.yanolja.com/v5/2024/07/04/11/1280/6686849dd7ba98.36523125.jpg"
									decoding="async" data-nimg="fill" class="css-sr2c7j">
								<div class="cover">
									경주 한옥호텔 춘추관 펜션 <br>
									<br> 98,000원 ~
				...
				<div class="content_5">놀면 뭐 타지? ✈️</div>
				<div class="content_6">
					<!-- Swiper -->
					<div class="swiper mySwiper">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide" type="button"
								...
								<div class="cover">
									내 맘 대로 <br> 소요시간 조회 하기
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="content_7">포브스 선정 경주에서 가볼만한 곳 TOP 7 👍</div>
				<div class="content_8">
					<!-- Swiper -->
					<div class="swiper mySwiper">
						<div class="swiper-wrapper">
